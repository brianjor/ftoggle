...
WITH
  ...
  createProjectContextFieldId   AS (SELECT id FROM "permissions" WHERE "name" = 'CREATE_PROJECT_CONTEXT_FIELD'),
...
VALUES
  ...
  ((SELECT id FROM adminRoleId), (SELECT id FROM createProjectContextFieldId)),
  ((SELECT id FROM adminRoleId), (SELECT id FROM createFeatureConditionId)),
  ((SELECT id FROM adminRoleId), (SELECT id FROM viewProjectContextFieldsId)),
  ((SELECT id FROM adminRoleId), (SELECT id FROM deleteProjectContextFieldId)),
  ((SELECT id FROM adminRoleId), (SELECT id FROM deleteFeatureConditionId)),
	((SELECT id FROM adminRoleId), (SELECT id FROM viewFeatureToggleConditionId));
--> statement-breakpoint
...
VALUES
  ...
  ((SELECT id FROM editorRoleId), (SELECT id FROM createProjectContextFieldId)),
  ((SELECT id FROM editorRoleId), (SELECT id FROM createFeatureConditionId)),
  ((SELECT id FROM editorRoleId), (SELECT id FROM viewProjectContextFieldsId)),
  ((SELECT id FROM editorRoleId), (SELECT id FROM deleteProjectContextFieldId)),
  ((SELECT id FROM editorRoleId), (SELECT id FROM deleteFeatureConditionId)),
	((SELECT id FROM editorRoleId), (SELECT id FROM viewFeatureToggleConditionId));
--> statement-breakpoint
...
VALUES
  ...
  ((SELECT id FROM viewerRoleId), (SELECT id FROM viewProjectContextFieldsId)),
	((SELECT id FROM viewerRoleId), (SELECT id FROM viewFeatureToggleConditionId));
--> statement-breakpoint
